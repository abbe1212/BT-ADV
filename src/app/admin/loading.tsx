  ...
  return (
    <div className="flex h-full min-h-[60vh] w-full items-center justify-center flex-col gap-6">
      <div className="relative">
        <div className="w-16 h-16 border-4 border-border-input rounded-full"></div>
        <div className="absolute top-0 left-0 w-16 h-16 border-4 border-yellow rounded-full border-t-transparent animate-spin"></div>
      </div>
